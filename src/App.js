    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/library" element={currentUser  ? <Library currentUser ={currentUser } /> : <Navigate to="/login" />} />
                <Route path="/" element={currentUser  ? <Navigate to="/library" /> : <Navigate to="/login" />} />
                <Route path="*" element={<Navigate to={currentUser  ? "/library" : "/login"} />} />
            </Routes>
        </Router>
    );
};
